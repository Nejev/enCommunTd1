...
<div class="container">
        ...
        <ul>
            <c:forEach items="${listCompetenceUser}" var="competenceUser">
                <li class="list-group-item">
                        ${competenceUser.getType().getIntituleC()}
                    (niveau ${competenceUser.getNiveau()}) ${competenceUser.getCommentaire()} <a
                        href=/td3_war/competence/competenceMembreD?intituleCM=${competenceUser.getType().getIntituleC()}>Supprimer</a>
                </li>
            </c:forEach>
        </ul>
        <br>
    ...
    <div class="right">
        ...
        <form action="/td3_war/competence/competenceMembreP" method="post">
            Compétence:
        ...
        <form action="/td3_war/competence/competenceP" method="post">
