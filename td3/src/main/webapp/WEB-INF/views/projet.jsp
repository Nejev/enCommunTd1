    ...
    <ul class="list-group">
        <c:forEach items="${listDirigeP}" var="dirigeP">
            <li class="list-group-item">
                    ...
                    href=/td3_war/projet/projetD?intituleP=${dirigeP.getIntituleP()}>Supprimer</a>
            </li>
        </c:forEach>
    </ul>
    ...
    <ul class="list-group">
        <c:forEach items="${listParticipeP}" var="participeP">
            <li class="list-group-item">
                    ...
                    href=/td3_war/projet/projetPQuit?intituleP=${participeP.getIntituleP()}>Quitter</a>
            </li>
        </c:forEach>
    </ul>
        ...
        <c:forEach items="${listCompetenceP}" var="competenceP">
            <li class="list-group-item">
                <span class="green"> ${competenceP.getIntituleP()}</span> <a
                    href=/td3_war/projet/projetPParticipe?intituleP=${competenceP.getIntituleP()}>Participer</a>
            </li>
        </c:forEach>
...
<div class="right">
    ...
    <form action="/td3_war/projet/projetP" method="post">
